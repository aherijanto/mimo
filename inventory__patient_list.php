...
connect_db('localhost','root','root','cappamed');
		...
		$sqlinsert = "SELECT * from cdtptn ORDER BY ptncode ASC;";
	...
	echo "<tr> <th>PATIENT CODE</th> <th>FULL NAME</th> <th>QTY ADDRESS</th> <th>KELURAHAN</th><th>KECAMATAN</th> <th>TGL.LAHIR</th><th>PHONE</th><th>GENDER</th><th>BLOOD TYPE</th><th>RELIGION</th><th></th> <th></th></tr>";
