...
<div class="txt-heading">Shopping Cart <a id="btnEmpty" href="opensales.php?action=empty">Empty Cart</a></div>
<?php
...
<?php		
    foreach ($_SESSION["cart_item"] as $item){
		?>
				...
				<td><a href="opensales.php?action=remove&code=<?php echo $item["code"]; ?>" class="btnRemoveAction">Remove Item</a></td>
				</tr>
				<?php
...
<div id="product-grid">
	...
	<?php
	$product_array = $db_handle->runQuery("SELECT * FROM cdtitem ORDER BY itemcode ASC");
	if (!empty($product_array)) { 
		foreach($product_array as $key=>$value){
	?>
		<div class="product-item">
			<form method="post" action="opensales.php?action=add&code=<?php echo $product_array[$key]["itemcode"]; ?>">
			<div class="product-image"><img src="<?php echo $product_array[$key]["image"]; ?>"></div>
			<div><strong><?php echo $product_array[$key]["itemname"]; ?></strong></div>
			<div class="product-price"><?php echo "Rp. ".$product_array[$key]["opprice"]; ?></div>
